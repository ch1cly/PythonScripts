...
def draw():
    ...
    glVertexPointer(3, GL_FLOAT, 0, pointdata) #glVertexPointer(3, GL_FLOAT, 0, pointdata)
    # Указываем, где взять массив цветов:
    # Параметры аналогичны, но указывается массив цветов
    glColorPointer(3, GL_FLOAT, 0, pointcolor) #!glColorPointer(3, GL_FLOAT, 0, pointcolor)
    ...
    glDrawArrays(GL_QUADS, 0, 4) #!glDrawArrays(GL_TRIANGLES, 0, 3)
