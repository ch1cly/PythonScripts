...
def drawxy(x,y,k):
    ...
    glTranslatef(x, y, 0)                                      # Сдвинемся по оси x y
    ...
    glTranslatef(0.0, 0.0, k*0.2)                                 # Сдвинемся по оси Z на 0.2
    # Рисуем нижние ветки (конус) с радиусом 0.5, высотой 0.5
    # Последние два числа определяют количество полигонов
    glutSolidCone(k*0.5, k*0.5, 20, 20)
    glTranslatef(0.0, 0.0, k*0.3)                                 # Сдвинемся по оси Z на -0.3
    glutSolidCone(k*0.4, k*0.4, 20, 20)                             # Конус с радиусом 0.4, высотой 0.4
    glTranslatef(0.0, 0.0, k*0.3)                                 # Сдвинемся по оси Z на -0.3
    glutSolidCone(k*0.3, k*0.3, 20, 20)                             # Конус с радиусом 0.3, высотой 0.3
...
glutCreateWindow(b"Blin blinskii do novogo goda 1234567865433 dnei!!!!")
